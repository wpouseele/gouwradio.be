...
$replace_mapped_drive_locations = sfConfig::get( 'app_mdl_replace' );
...
foreach ($itunes_music_libraries as $number => $itunes_music_library)
{
	...
	while( $value = $itunes_parser->getTrack() )
	{
	  ...
	  $location = StreemeUtil::itunes_format_decode( $value[ 'Location' ], $replace_mapped_drive_locations, $mapped_drive_locations);
