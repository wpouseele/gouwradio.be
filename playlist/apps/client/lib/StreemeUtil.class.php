...
class StreemeUtil
{
  ...
  * @param replace_mdl             bool: true if we need to replace the mapped drive locations
  ...
  */
  public static function itunes_format_decode( $itunes_url, $replace_mdl = false, $mapped_drive_locations = array() )
  {
    $filename = null;
